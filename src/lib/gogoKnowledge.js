...
const TOPICS = [
  {
    ...
    replies: {
      en: "I am Fooz, your AI assistant. I help you around SCORA — TCS, PQA, Search, Feedback, and Academy tools. What would you like to explore?",
      ar: 'أنا Fooz، مساعدك الذكي. بساعدك في SCORA — TCS وPQA والبحث والملاحظات وأدوات الأكاديمية. تحب نبدأ بإيه؟',
    },
  ...
  },
  {
    ...
    replies: {
      en: "Hey! I'm Fooz, your friendly AI assistant for SCORA. Ask me anything about TCS, PQA, Search, or Feedback — or tap a topic below.",
      ar: 'أهلاً! أنا Fooz مساعدك الودود في SCORA. اسألني عن TCS أو PQA أو البحث أو الملاحظات — أو اختار موضوع من الأزرار.',
    },
  ...
  },
  {
    ...
    replies: {
      en: "Nice to meet you too! I'm Fooz — glad you're here. What should we look at first?",
...
const DENIED_REPLY = {
  en: "I'd love to help with everything, but I'm Fooz for SCORA only — TCS, PQA, Search, Feedback, and KPIs. Pick a topic below!",
  ar: 'نفسي أساعد في كل حاجة، بس أنا Fooz لـ SCORA بس — TCS وPQA والبحث والملاحظات والمؤشرات. اختار موضوع من تحت!',
};

const FALLBACK = {
  en: "Happy to help! Ask me about SCORA, TCS, PQA, or Search — or tap a guided chip. I'm Fooz, your AI assistant.",
  ar: 'فرحان أساعد! اسألني عن SCORA أو TCS أو PQA أو البحث — أو اختار من الاقتراحات. أنا Fooz، مساعدك الذكي.',
};
