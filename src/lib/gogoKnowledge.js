...
const TOPICS = [
  {
    ...
    replies: {
      en: "I am GOGO, your AI assistant. I help you around SCORA — TCS, PQA, Search, Feedback, Academy tools, and My Knowledge. What would you like to explore?",
      ar: 'أنا اسمي جوجو، مساعدك الذكي. بساعدك في SCORA — TCS وPQA والبحث والملاحظات وأدوات الأكاديمية ولوحة المعرفة. تحب نبدأ بإيه؟',
    },
  ...
  },
  {
    ...
    replies: {
      en: 'Samsung is our company — and SCORA is Samsung Egypt’s service performance hub for TCS, PQA, Search, Feedback, and Academy tools.',
      ar: 'سامسونج هي شركتنا — وسكورا مركز أداء خدمة سامسونج مصر لـ TCS وPQA والبحث والملاحظات وأدوات الأكاديمية.',
    },
    chips: ['what_scora', 'what_tcs', 'what_pqa'],
  },
  {
  ...
  },
  {
    ...
    replies: {
      en: 'The Samsung Academy Survey is a short visitor form in SCORA. I can open it for you.',
      ar: 'استبيان Samsung Academy فورم قصير في سكورا. أقدر أفتحهالك.',
    },
    action: 'goto_survey',
  ...
  },
  {
    ...
    replies: {
      en: 'Scora Challenge is a live quiz. Join with a session link or QR when a challenge is running.',
      ar: 'Scora Challenge اختبار مباشر. ادخل برابط الجلسة أو رمز QR لما يكون التحدي شغال.',
    },
