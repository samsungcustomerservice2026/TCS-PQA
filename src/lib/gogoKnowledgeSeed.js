...
export const GOGO_SEED_QA = [
  {
    id: 'who_are_you',
    keywords: ['who are you', 'your name', 'fooz', 'مين انت', 'اسمك', 'عرّف', 'مساعد'],
    question_en: 'Who are you?',
    question_ar: 'مين انت؟',
    answer_en:
      'I am Fooz, your AI assistant. I help you around SCORA — TCS, PQA, Search, Feedback, and Academy tools.',
    answer_ar:
      'أنا Fooz، مساعدك الذكي. بساعدك في SCORA — TCS وPQA والبحث والملاحظات وأدوات الأكاديمية.',
    category: 'identity',
  },
  {
    id: 'what_is_scora',
    ...
    answer_en:
      'SCORA is Samsung Egypt’s service performance hub. Visitors use TCS, PQA, Feedback, Academy Survey, and Scora Challenge. Ask Fooz anytime!',
    answer_ar:
      'SCORA هو مركز أداء خدمة سامسونج مصر. الزوار يستخدمون TCS وPQA والملاحظات واستبيان الأكاديمية وScora Challenge. اسأل Fooz في أي وقت!',
    category: 'overview',
  },
  {
    id: 'what_is_tcs',
